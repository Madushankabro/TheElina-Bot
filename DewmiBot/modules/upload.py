...
from DewmiBot import telethn as bot
from DewmiBot.modules.urluploader import download_file
from DewmiBot.utils.uputils import humanbytes, progress
    ...
    if event.reply_to_msg_id:
        ...
        try:
            ...
            await bot.send_file(
                ...
                dosya,
                force_document=True,
                caption=f"Uploaded By @szrosebot🇱🇰",
            )
        except Exception as e:
            traceback.print_exc()
