...
# from DewmiBot.db.mongo_helpers.nsfw_guard import add_chat, get_all_nsfw_chats, is_chat_in_db, rm_chat
from DewmiBot.function.telethonbasics import is_admin
from DewmiBot.services.events import register
from DewmiBot.services.mongo import mongodb as db
from DewmiBot.services.sql.nsfw_watch_sql import (
    add_nsfwatch,
    get_all_nsfw_enabled_chat,
    is_nsfwatch_indb,
    rmnsfwatch,
)
from DewmiBot.services.telethon import tbot
        ...
        if event.photo:
            if event.chat_id == c["id"]:
                ...
                if nude.is_nude("./nudes.jpg"):
                    ...
                    st = sender.first_name
                    hh = sender.id
                    final = f"**NSFW DETECTED**\n\n[{st}](tg://user?id={hh}) your message contain NSFW content.. So, **Ξ L I N Λ 👸** deleted the message\n\n **Nsfw Sender - User / Bot :** [{st}](tg://user?id={hh}) \n\n Automatic Detections Powered By [Ξ L I N Λ 👸](https://telegra.ph/file/2d5ccb6d0d312a0685719.jpg) \n\n**#GROUP_GUARDIAN** "
                    dev = await event.respond(final)
                    await asyncio.sleep(10)
                    await dev.delete()
                    os.remove("nudes.jpg")
...
__help__ = """
<b> Group Guardian: </b>
❍ Ξ L I N Λ 👸  can protect your group from NSFW senders, Slag word users and also can force members to use English
