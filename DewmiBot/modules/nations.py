...
from DewmiBot.modules.helper_funcs.chat_status import whitelist_plus, dev_plus, sudo_plus
from DewmiBot.modules.helper_funcs.extraction import extract_user
from DewmiBot.modules.log_channel import gloggable
from DewmiBot.modules.sql import nation_sql as sql
from DewmiBot.modules.helper_funcs.decorators import kigcmd
...
nations = """ ΞLINΛ has bot access levels we call as *"Nation Levels"*
...
Owner has complete bot access, including bot adminship in chats ΞLINΛ is at.
\n*Royals* - Have super user access, can gban, manage Nations lower than them and are admins in ΞLINΛ.
\n*Sakuras* - Have access go globally ban users across ΞLINΛ.
...
\n*Disclaimer*: The Nation levels in ΞLINΛ are there for troubleshooting, support, banning potential scammers.
